...
#' @param stubble_decay rate at which stubble decays reducing the number of infective
#'  sites from chick pea residue. rate is given as a proportion of infective sites
#'  on stubble which survive between rainfall events.
#'
...
one_day <- function(i_date,
  ...
  times <- temp <- rain <- new_gp <- infectious_gp <-
    ...
    spores_per_packet <- rain_sum <- stubble_lesions <- NULL
